...
// Returns the private 'App\Repository\ExchangeRatesRepository' shared autowired service.
...
include_once $this->targetDirs[3].'\\src\\Repository\\ExchangeRatesRepository.php';

return $this->privates['App\\Repository\\ExchangeRatesRepository'] = new \App\Repository\ExchangeRatesRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
